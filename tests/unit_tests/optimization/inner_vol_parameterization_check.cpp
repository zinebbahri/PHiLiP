...
int main (int argc, char * argv[])
{
    ...
    const bool is_mesh_updated = design_parameterization->update_mesh_from_design_variables(dXv_dXp, design_var_updated); // Expected to update inner volume nodes by change_in_val.
