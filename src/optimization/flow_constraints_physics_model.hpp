#ifndef __FLOWCONSTRAINTSPHYSICSMODEL_H__
#define __FLOWCONSTRAINTSPHYSICSMODEL_H__
 ...
 */
template<int dim>
class FlowConstraintsPhysicsModel : public ROL::Constraint_SimOpt<double> {
private:
    /// MPI rank used for printing.
    const int mpi_rank;
    /// Whether the current processor should print or not.
    const bool i_print;
    /// Smart pointer to sub DGBase
