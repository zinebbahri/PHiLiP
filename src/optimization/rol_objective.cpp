...
void ROLObjectiveSimOpt<dim,nstate>::hessVec_11(
  [[maybe_unused]] ROL::Vector<double> &output_vector,
  [[maybe_unused]] const ROL::Vector<double> &input_vector,
  [[maybe_unused]]   const ROL::Vector<double> &des_var_sim,
  [[maybe_unused]]   const ROL::Vector<double> &des_var_ctl,
    double &/*tol*/ )
{
    // update(des_var_sim, des_var_ctl);
