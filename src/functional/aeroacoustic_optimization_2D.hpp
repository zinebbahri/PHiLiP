...
public:
     ...
     */
    AeroAcousticOptimization2D(const Parameters::AllParameters *const parameters_input);
...
/// Performs grid convergence for various polynomial degrees.
template <int dim, int nstate>
class AeroAcousticOptimization2DConstrained: public TestsBase
{
public:
    /// Constructor. Deleted the default constructor since it should not be used
    AeroAcousticOptimization2DConstrained () = delete;
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     */
    AeroAcousticOptimization2DConstrained(const Parameters::AllParameters *const parameters_input);
...
/// Performs grid convergence for various polynomial degrees.
template <int dim, int nstate>
class ViscousNACAOptimization: public TestsBase
{
public:
    /// Constructor. Deleted the default constructor since it should not be used
    ViscousNACAOptimization () = delete;
    /// Constructor.
    /** Simply calls the TestsBase constructor to set its parameters = parameters_input
     */
