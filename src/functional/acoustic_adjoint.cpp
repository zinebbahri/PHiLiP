...
//---------------------------------------------------------------------
template <int dim, int nstate, typename real, typename MeshType>
void AcousticAdjoint<dim, nstate, real, MeshType>::compute_dIdXd_FD(std::shared_ptr<DGBase<dim, double>> dg, const double eps){
...
//create ffd box
 ...
 auto old_volume_nodes = dg->high_order_grid->volume_nodes;
 ...
 // Perturb
    ...
    // std::string filename = "perturbed_grid";
    // filename += ".vtu";
